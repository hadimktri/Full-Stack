...
export const users = [
  { id: 1, name: "john", email: "john123@gmail.com", password: "123456789" },
  {
    id: 2,
    name: "sandra",
    email: "sandra123@gmail.com",
    password: "123456789",
  },
];
...
export const updatePost = (values: any, id: any) => {
  let post = posts[posts.indexOf(posts.filter((p) => p.id == id)[0])];
